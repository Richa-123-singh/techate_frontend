...
@Component({
  selector: 'app-present-faces',
  templateUrl: './present-faces.component.html',
  styleUrls: ['./present-faces.component.css']
})
export class PresentFacesComponent implements OnInit {
  allStudents:any;
  presentStudents:any;
...
getpresentStudents(){
  return new Promise((res,rej)=>{
    this.addFuncObj.getPresentFace()
    .toPromise()
    .then(
      response=>{
